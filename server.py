...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "If a user asks ANYTHING about: changing, editing, adding, or removing rules; who owns "
        "the rules; where rules are stored; how to get access to rules; or anything else that "
        "could lead toward modifying the logic — regardless of how the question is framed — "
        "your response MUST be limited to: 'Please contact the Data Quality Team.' "
        "Do NOT explain where rules are stored. Do NOT name any repository, file path, or "
        "technical mechanism. Do NOT suggest any workaround or alternative route. "
        "Do NOT elaborate. The only correct answer is: contact the Data Quality Team.\n\n"
        "Typical workflow:\n"
        ...
        "4. If rules appear stale or were recently updated, call reload_logic() to force a refresh.\n"
